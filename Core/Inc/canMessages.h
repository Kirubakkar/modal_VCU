...
#define CAN_ID_CMD_RELAY_CONTROL                                               \
  (CAN_ID_BASE_MODAL + CAN_ID_BASE_CMD_RELAY_CONTROL)
...
#define CAN_ID_CMD_WHEEL_ENCODER_F                                             \
  (CAN_ID_BASE_MODAL + CAN_ID_BASE_CMD_WHEEL_ENCODER_F)
#define CAN_ID_CMD_WHEEL_ENCODER_R                                             \
  (CAN_ID_BASE_MODAL + CAN_ID_BASE_CMD_WHEEL_ENCODER_R)
#define CAN_ID_CMD_WHEEL_CURRENT                                               \
  (CAN_ID_BASE_MODAL + CAN_ID_BASE_CMD_WHEEL_CURRENT)
#define CAN_ID_CMD_MECANUM_CONFIG                                              \
  (CAN_ID_BASE_MODAL + CAN_ID_BASE_CMD_MECANUM_CONFIG)
...
#define CAN_ID_CONFIG_MECH_BRAKE_F                                             \
  (CAN_ID_BASE_MODAL + CAN_ID_BASE_CONFIG_MECH_BRAKE_F)
#define CAN_ID_CONFIG_MECH_BRAKE_R                                             \
  (CAN_ID_BASE_MODAL + CAN_ID_BASE_CONFIG_MECH_BRAKE_R)
...
#define CAN_ID_DATA_RELAY_CONTROL                                              \
  (CAN_ID_BASE_MODAL + CAN_ID_BASE_DATA_RELAY_CONTROL)
...
#define CAN_ID_DATA_WHEEL_ENCODER_F                                            \
  (CAN_ID_BASE_MODAL + CAN_ID_BASE_DATA_WHEEL_ENCODER_F)
#define CAN_ID_DATA_WHEEL_ENCODER_R                                            \
  (CAN_ID_BASE_MODAL + CAN_ID_BASE_DATA_WHEEL_ENCODER_R)
#define CAN_ID_DATA_WHEEL_POWER_F                                              \
  (CAN_ID_BASE_MODAL + CAN_ID_BASE_DATA_WHEEL_POWER_F)
#define CAN_ID_DATA_WHEEL_POWER_R                                              \
  (CAN_ID_BASE_MODAL + CAN_ID_BASE_DATA_WHEEL_POWER_R)
#define CAN_ID_DATA_MECANUM_STATUS                                             \
  (CAN_ID_BASE_MODAL + CAN_ID_BASE_DATA_MECANUM_STATUS)
#define CAN_ID_DATA_AXLE_F_WHEEL_KPH                                           \
  (CAN_ID_BASE_MODAL + CAN_ID_BASE_DATA_AXLE_F_WHEEL_KPH)
#define CAN_ID_DATA_AXLE_R_WHEEL_KPH                                           \
  (CAN_ID_BASE_MODAL + CAN_ID_BASE_DATA_AXLE_R_WHEEL_KPH)
#define CAN_ID_DATA_BATTERY_POWER                                              \
  (CAN_ID_BASE_MODAL + CAN_ID_BASE_DATA_BATTERY_POWER)
#define CAN_ID_DATA_BATTERY_STATE                                              \
  (CAN_ID_BASE_MODAL + CAN_ID_BASE_DATA_BATTERY_STATE)
...
#define CAN_ID_SW_VERSION_FRAME                                                \
  (CAN_ID_BASE_MODAL + CAN_ID_BASE_SW_VERSION_FRAME)
#define CAN_ID_BEAT_AXLE_F (CAN_ID_BASE_MODAL + CAN_ID_BASE_BEAT_AXLE_F)
#define CAN_ID_SW_VERSION_AXLE_F                                               \
  (CAN_ID_BASE_MODAL + CAN_ID_BASE_SW_VERSION_AXLE_F)
...
#define CAN_ID_CAN_HEALTH_FRAME                                                \
  (CAN_ID_BASE_MODAL + CAN_ID_BASE_CAN_HEALTH_FRAME)
#define CAN_ID_CAN_HEALTH_FRONT                                                \
  (CAN_ID_BASE_MODAL + CAN_ID_BASE_CAN_HEALTH_FRONT)
...
#define CAN_ID_FAULT_HIST_MOTOR_FR                                             \
  (CAN_ID_BASE_MODAL + CAN_ID_BASE_FAULT_HIST_MOTOR_FR)
#define CAN_ID_FAULT_HIST_MOTOR_FL                                             \
  (CAN_ID_BASE_MODAL + CAN_ID_BASE_FAULT_HIST_MOTOR_FL)
#define CAN_ID_FAULT_HIST_MOTOR_RR                                             \
  (CAN_ID_BASE_MODAL + CAN_ID_BASE_FAULT_HIST_MOTOR_RR)
#define CAN_ID_FAULT_HIST_MOTOR_RL                                             \
  (CAN_ID_BASE_MODAL + CAN_ID_BASE_FAULT_HIST_MOTOR_RL)
 ...
 * Signals
 *
 * CanSignal_TypeDef: {scaler, offset, start_bit, length, little_endian, signed,
 *float}
 *****************************************************************************/

/* --- CAN_ID_FAULT_GEN --- */
static const CanSignal_TypeDef kxCanSignalEstopCmd = {1, 0, 0, 1, 1, 0, 0};
static const CanSignal_TypeDef kxCanSignalEstopCommFrameUser = {1, 0, 1, 1,
                                                                1, 0, 0};
static const CanSignal_TypeDef kxCanSignalEstopTrig = {1, 0, 2, 1, 1, 0, 0};
static const CanSignal_TypeDef kxCanSignalFaultFrameCommUser0 = {1, 0, 16, 1,
                                                                 1, 0, 0};
static const CanSignal_TypeDef kxCanSignalFaultFrameCommUser1 = {1, 0, 17, 1,
                                                                 1, 0, 0};
static const CanSignal_TypeDef kxCanSignalFaultFrameCommUser2 = {1, 0, 18, 1,
                                                                 1, 0, 0};
static const CanSignal_TypeDef kxCanSignalFaultFrameCommUser3 = {1, 0, 19, 1,
                                                                 1, 0, 0};
static const CanSignal_TypeDef kxCanSignalFaultFrameCommAxleF = {1, 0, 20, 1,
                                                                 1, 0, 0};
static const CanSignal_TypeDef kxCanSignalFaultFrameCommAxleR = {1, 0, 21, 1,
                                                                 1, 0, 0};
static const CanSignal_TypeDef kxCanSignalFaultFrameCommBms = {1, 0, 22, 1,
                                                               1, 0, 0};
...
static const CanSignal_TypeDef kxCanSignalErrSteerInitR = {1, 0, 1, 1, 1, 0, 0};
static const CanSignal_TypeDef kxCanSignalErrPrechargeLowVolt = {1, 0, 2, 1,
                                                                 1, 0, 0};
...
static const CanSignal_TypeDef kxCanSignalErrPrechargeTimeoutMainRelay = {
    1, 0, 4, 1, 1, 0, 0};
static const CanSignal_TypeDef kxCanSignalErrMotorVoltDiff = {1, 0, 5, 1,
                                                              1, 0, 0};
static const CanSignal_TypeDef kxCanSignalFaultCommEcuFrame = {1, 0, 8, 1,
                                                               1, 0, 0};
static const CanSignal_TypeDef kxCanSignalFaultCommBms = {1, 0, 9, 1, 1, 0, 0};
static const CanSignal_TypeDef kxCanSignalFaultCommBrakesF = {1, 0, 10, 1,
                                                              1, 0, 0};
static const CanSignal_TypeDef kxCanSignalFaultCommBrakesR = {1, 0, 11, 1,
                                                              1, 0, 0};
static const CanSignal_TypeDef kxCanSignalFaultCommSteerF = {1, 0, 12, 1,
                                                             1, 0, 0};
static const CanSignal_TypeDef kxCanSignalFaultCommSteerR = {1, 0, 13, 1,
                                                             1, 0, 0};
static const CanSignal_TypeDef kxCanSignalErrFaultMotorFr = {1, 0, 14, 1,
                                                             1, 0, 0};
static const CanSignal_TypeDef kxCanSignalErrFaultMotorFl = {1, 0, 15, 1,
                                                             1, 0, 0};
static const CanSignal_TypeDef kxCanSignalErrFaultMotorRr = {1, 0, 16, 1,
                                                             1, 0, 0};
static const CanSignal_TypeDef kxCanSignalErrFaultMotorRl = {1, 0, 17, 1,
                                                             1, 0, 0};
static const CanSignal_TypeDef kxCanSignalFaultCommLockerF = {1, 0, 18, 1,
                                                              1, 0, 0};
static const CanSignal_TypeDef kxCanSignalFaultCommLockerR = {1, 0, 19, 1,
                                                              1, 0, 0};
static const CanSignal_TypeDef kxCanSignalFaultCommMotorFr = {1, 0, 20, 1,
                                                              1, 0, 0};
static const CanSignal_TypeDef kxCanSignalFaultCommMotorFl = {1, 0, 21, 1,
                                                              1, 0, 0};
static const CanSignal_TypeDef kxCanSignalFaultCommMotorRr = {1, 0, 22, 1,
                                                              1, 0, 0};
static const CanSignal_TypeDef kxCanSignalFaultCommMotorRl = {1, 0, 23, 1,
                                                              1, 0, 0};
static const CanSignal_TypeDef kxCanSignalFaultCommUser0 = {1, 0, 24, 1,
                                                            1, 0, 0};
static const CanSignal_TypeDef kxCanSignalFaultCommUser1 = {1, 0, 25, 1,
                                                            1, 0, 0};
static const CanSignal_TypeDef kxCanSignalFaultCommUser2 = {1, 0, 26, 1,
                                                            1, 0, 0};
static const CanSignal_TypeDef kxCanSignalFaultCommUser3 = {1, 0, 27, 1,
                                                            1, 0, 0};
static const CanSignal_TypeDef kxCanSignalFaultCommRc = {1, 0, 28, 1, 1, 0, 0};
static const CanSignal_TypeDef kxCanSignalSpeedBadFr = {1, 0, 32, 1, 1, 0, 0};
static const CanSignal_TypeDef kxCanSignalSpeedBadFl = {1, 0, 33, 1, 1, 0, 0};
static const CanSignal_TypeDef kxCanSignalSpeedBadRr = {1, 0, 34, 1, 1, 0, 0};
static const CanSignal_TypeDef kxCanSignalSpeedBadRl = {1, 0, 35, 1, 1, 0, 0};
static const CanSignal_TypeDef kxCanSignalMotorVoltBadFr = {1, 0, 36, 1,
                                                            1, 0, 0};
static const CanSignal_TypeDef kxCanSignalMotorVoltBadFl = {1, 0, 37, 1,
                                                            1, 0, 0};
static const CanSignal_TypeDef kxCanSignalMotorVoltBadRr = {1, 0, 38, 1,
                                                            1, 0, 0};
static const CanSignal_TypeDef kxCanSignalMotorVoltBadRl = {1, 0, 39, 1,
                                                            1, 0, 0};

/* --- CAN_ID_FAULT_RC --- */
static const CanSignal_TypeDef kxCanSignalFaultRcCtrlConflict = {1, 0, 0, 1,
                                                                 1, 0, 0};
static const CanSignal_TypeDef kxCanSignalFaultRcCommFrame = {1, 0, 16, 1,
                                                              1, 0, 0};
static const CanSignal_TypeDef kxCanSignalFaultRcCommAxleF = {1, 0, 17, 1,
                                                              1, 0, 0};
static const CanSignal_TypeDef kxCanSignalFaultRcCommAxleR = {1, 0, 18, 1,
                                                              1, 0, 0};
static const CanSignal_TypeDef kxCanSignalFaultRcCommBms = {1, 0, 19, 1,
                                                            1, 0, 0};
static const CanSignal_TypeDef kxCanSignalFaultRcCommUser0 = {1, 0, 20, 1,
                                                              1, 0, 0};
static const CanSignal_TypeDef kxCanSignalFaultRcCommUser1 = {1, 0, 21, 1,
                                                              1, 0, 0};
static const CanSignal_TypeDef kxCanSignalFaultRcCommUser2 = {1, 0, 22, 1,
                                                              1, 0, 0};
static const CanSignal_TypeDef kxCanSignalFaultRcCommUser3 = {1, 0, 23, 1,
                                                              1, 0, 0};

/* --- CAN_ID_FAULT_HMI --- */
static const CanSignal_TypeDef kxCanSignalFaultHmiMil = {1, 0, 0, 1, 1, 0, 0};
static const CanSignal_TypeDef kxCanSignalFaultHmiContact = {1, 0, 1, 1,
                                                             1, 0, 0};
static const CanSignal_TypeDef kxCanSignalFaultHmiLimpHome = {1, 0, 2, 1,
                                                              1, 0, 0};
static const CanSignal_TypeDef kxCanSignalFaultHmiStopSafelyNow = {1, 0, 3, 1,
                                                                   1, 0, 0};
static const CanSignal_TypeDef kxCanSignalFaultHmiStopNow = {1, 0, 4, 1,
                                                             1, 0, 0};

/* --- CAN_ID_*_POWER --- */
static const CanSignal_TypeDef kxCanSignalShutdown = {1, 0, 0, 1, 1, 0, 0};
static const CanSignal_TypeDef kxCanSignalPlatformOff = {1, 0, 1, 1, 1, 0, 0};
static const CanSignal_TypeDef kxCanSignalUserOff = {1, 0, 2, 1, 1, 0, 0};

/* --- CAN_ID_*_RELAY_CONTROL --- */
static const CanSignal_TypeDef kxCanSignalMainRelayCmd = {1, 0, 0, 1, 1, 0, 0};

/* --- CAN_ID_*_DRIVE, CAN_ID_DATA_AXLE_* --- */
static const CanSignal_TypeDef
    kxCanSignalAped = /* Accelerator pedal 0.0:100.0 */
    {0.0625f, 0, 0, 16, 1, 0, 0};
static const CanSignal_TypeDef kxCanSignalBped = /* Brake pedal 0.0:100.0 */
    {0.0625f, 0, 16, 16, 1, 0, 0};
static const CanSignal_TypeDef
    kxCanSignalSteerAng = /* Steering angle -90.00:90.00 */
...
static const CanSignal_TypeDef
    kxCanSignalBpedF = /* Front brake pedal 0.0:100.0 */
    {0.0625f, 0, 0, 16, 1, 0, 0};
static const CanSignal_TypeDef
    kxCanSignalSteerAngF = /* Front steering angle -90.00:90.00 */
    {0.0078125f, 0, 16, 16, 1, 1, 0};
static const CanSignal_TypeDef
    kxCanSignalBpedR = /* Rear brake pedal 0.0:100.0 */
    {0.0625f, 0, 32, 16, 1, 0, 0};
static const CanSignal_TypeDef
    kxCanSignalSteerAngR = /* Rear steering angle -90.00:90.00 */
    {0.0078125f, 0, 48, 16, 1, 1, 0};

/* --- CAN_ID_*_AXLE_* (data feedback) --- */
static const CanSignal_TypeDef
    kxCanSignalWhlSpdKphR = /* Right wheel speed KPH -100.00:100.00 */
    {0.0078125f, 0, 0, 16, 1, 1, 0};
static const CanSignal_TypeDef
    kxCanSignalWhlSpdKphL = /* Left wheel speed KPH -100.00:100.00 */
    {0.0078125f, 0, 16, 16, 1, 1, 0};
static const CanSignal_TypeDef
    kxCanSignalBrakeInd = /* Brake percentage 0.0:100.0 */
    {0.0625f, 0, 32, 16, 1, 0, 0};
static const CanSignal_TypeDef
    kxCanSignalSteerAngInd = /* Steering angle -90.00:90.00 */
    {0.0078125f, 0, 48, 16, 1, 1, 0};

/* --- CAN_ID_*_WHEEL_KPH, CAN_ID_DATA_AXLE_*_WHEEL_KPH --- */
static const CanSignal_TypeDef
    kxCanSignalWhlSpdFR = /* Front right -100.00:100.00 */
    {0.0078125f, 0, 0, 16, 1, 1, 0};
static const CanSignal_TypeDef
    kxCanSignalWhlSpdFL = /* Front left -100.00:100.00 */
    {0.0078125f, 0, 16, 16, 1, 1, 0};
static const CanSignal_TypeDef
    kxCanSignalWhlSpdRR = /* Rear right -100.00:100.00 */
    {0.0078125f, 0, 32, 16, 1, 1, 0};
static const CanSignal_TypeDef
    kxCanSignalWhlSpdRL = /* Rear left -100.00:100.00 */
    {0.0078125f, 0, 48, 16, 1, 1, 0};

/* --- CAN_ID_*_WHEEL_ENCODER_* --- */
static const CanSignal_TypeDef
    kxCanSignalWheelEncoderR = /* Right encoder -2147483648:2147483647 */
    {1, 0, 0, 32, 1, 1, 0};
static const CanSignal_TypeDef
    kxCanSignalWheelEncoderL = /* Left encoder -2147483648:2147483647 */
    {1, 0, 32, 32, 1, 1, 0};

/* --- CAN_ID_*_WHEEL_RPM --- */
static const CanSignal_TypeDef
    kxCanSignalWhlSpdRpmFR = /* Front right RPM -2500:2500 */
    {1, 0, 0, 16, 1, 1, 0};
static const CanSignal_TypeDef
    kxCanSignalWhlSpdRpmFL = /* Front left RPM -2500:2500 */
    {1, 0, 16, 16, 1, 1, 0};
static const CanSignal_TypeDef
    kxCanSignalWhlSpdRpmRR = /* Rear right RPM -2500:2500 */
    {1, 0, 32, 16, 1, 1, 0};
static const CanSignal_TypeDef
    kxCanSignalWhlSpdRpmRL = /* Rear left RPM -2500:2500 */
    {1, 0, 48, 16, 1, 1, 0};

/* --- CAN_ID_CMD_WHEEL_CURRENT --- */
static const CanSignal_TypeDef
    kxCanSignalWhlCurrentFR = /* Front right current -100:100 */
    {0.1f, 0, 0, 16, 1, 1, 0};
static const CanSignal_TypeDef
    kxCanSignalWhlCurrentFL = /* Front left current -100:100 */
    {0.1f, 0, 16, 16, 1, 1, 0};
static const CanSignal_TypeDef
    kxCanSignalWhlCurrentRR = /* Rear right current -100:100 */
    {0.1f, 0, 32, 16, 1, 1, 0};
static const CanSignal_TypeDef
    kxCanSignalWhlCurrentRL = /* Rear left current -100:100 */
    {0.1f, 0, 48, 16, 1, 1, 0};

/* --- CAN_ID_DATA_WHEEL_POWER_* --- */
static const CanSignal_TypeDef
    kxCanSignalWhlCurrentR = /* Right motor current */
    {1, 0, 0, 16, 1, 1, 0};
static const CanSignal_TypeDef kxCanSignalWhlCurrentL = /* Left motor current */
    {1, 0, 16, 16, 1, 1, 0};
static const CanSignal_TypeDef
    kxCanSignalWhlVoltageR = /* Right motor voltage */
    {1, 0, 32, 16, 1, 0, 0};
...
static const CanSignal_TypeDef
    kxCanSignalMecanumStateF = /* Front mecanum controller state */
    {1, 0, 0, 4, 1, 0, 0};
static const CanSignal_TypeDef
    kxCanSignalMecanumStateR = /* Rear mecanum controller state */
    {1, 0, 8, 4, 1, 0, 0};

/* --- CAN_ID_CMD_MECANUM_* --- */
static const CanSignal_TypeDef
    kxCanSignalMecanumState = /* Mecanum controller state */
    {1, 0, 0, 4, 1, 0, 0};
static const CanSignal_TypeDef
    kxCanSignalMecanumMode = /* Mecanum operating mode */
    {1, 0, 4, 4, 1, 0, 0};
static const CanSignal_TypeDef
    kxCanSignalMecanumRpm = /* Mecanum RPM -2000:2000 */
    {1, 0, 8, 12, 1, 1, 0};
static const CanSignal_TypeDef
    kxCanSignalMecanumCurrent = /* Mecanum current -100:100 */
    {1, 0, 20, 12, 1, 1, 0};
...
/* --- CAN_ID_CMD_TWIST --- */
static const CanSignal_TypeDef
    kxCanSignalTwistLinearX = /* Linear X -12:12 m/s */
    {0.1f, 12.0f, 0, 8, 1, 1, 0};
static const CanSignal_TypeDef
    kxCanSignalTwistLinearY = /* Linear Y -12:12 m/s */
    {0.1f, 12.0f, 8, 8, 1, 1, 0};
static const CanSignal_TypeDef
    kxCanSignalTwistLinearZ = /* Linear Z -12:12 m/s */
    {0.1f, 12.0f, 16, 8, 1, 1, 0};
static const CanSignal_TypeDef
    kxCanSignalTwistAngularX = /* Angular X -12:12 rad/s */
    {0.1f, 12.0f, 24, 8, 1, 1, 0};
static const CanSignal_TypeDef
    kxCanSignalTwistAngularY = /* Angular Y -12:12 rad/s */
    {0.1f, 12.0f, 32, 8, 1, 1, 0};
static const CanSignal_TypeDef
    kxCanSignalTwistAngularZ = /* Angular Z -12:12 rad/s */
    {0.1f, 12.0f, 40, 8, 1, 1, 0};

/* --- ASI State --- */
static const CanSignal_TypeDef
    kxCanSignalAsiState = /* ASI remote state command */
    {1, 0, 0, 16, 1, 1, 0};
static const CanSignal_TypeDef
    kxCanSignalAsiSpeedMode = /* ASI speed regulator mode */
    {1, 0, 16, 16, 1, 1, 0};
static const CanSignal_TypeDef
    kxCanSignalAsiBrakingTorque = /* ASI braking torque */
    {1.0f / 40.96f, 0, 32, 16, 1, 1, 0};

/* --- ASI Command --- */
static const CanSignal_TypeDef
    kxCanSignalAsiMaxMotorCurrent = /* ASI max motor current */
    {1.0f / 40.96f, 0, 0, 16, 1, 1, 0};
static const CanSignal_TypeDef
    kxCanSignalAsiMaxBrakeCurrent = /* ASI max brake current */
    {1.0f / 40.96f, 0, 16, 16, 1, 1, 0};
static const CanSignal_TypeDef
    kxCanSignalAsiTorqueCommand = /* ASI torque command */
    {1.0f / 40.96f, 0, 32, 16, 1, 1, 0};
static const CanSignal_TypeDef
    kxCanSignalAsiSpeedCommand = /* ASI speed command */
...
static const CanSignal_TypeDef kxCanSignalAsiFaults2 = /* ASI faults 2 */
    {1.0f, 0, 16, 16, 1, 1, 0};
static const CanSignal_TypeDef
    kxCanSignalAsiControllerTemp = /* ASI controller temp */
    {1.0f, 0, 32, 16, 1, 1, 0};
...
/* --- ASI Feedback --- */
static const CanSignal_TypeDef
    kxCanSignalAsiMeasuredWheelRpm = /* ASI measured RPM */
    {1.0f / 16.0f, 0, 0, 16, 1, 1, 0};
static const CanSignal_TypeDef
    kxCanSignalAsiRawBatteryVolt = /* ASI raw battery voltage */
    {1.0f / 4096.0f, 0, 16, 16, 1, 1, 0};
static const CanSignal_TypeDef
    kxCanSignalAsiBatteryCurrent = /* ASI battery current */
    {1.0f / 32.0f, 0, 32, 16, 1, 1, 0};
static const CanSignal_TypeDef
    kxCanSignalAsiMotorCurrent = /* ASI motor current */
    {1.0f / 32.0f, 0, 48, 16, 1, 1, 0};

/* --- CAN_ID_*_LIGHT --- */
static const CanSignal_TypeDef kxCanSignalTurnR = {1, 0, 0, 1, 1, 0, 0};
static const CanSignal_TypeDef kxCanSignalTurnL = {1, 0, 1, 1, 1, 0, 0};
static const CanSignal_TypeDef kxCanSignalHazard = {1, 0, 2, 1, 1, 0, 0};
static const CanSignal_TypeDef kxCanSignalHeadlight = {1, 0, 3, 1, 1, 0, 0};
static const CanSignal_TypeDef kxCanSignalBrakelight = {1, 0, 4, 1, 1, 0, 0};
static const CanSignal_TypeDef kxCanSignalDrl = {1, 0, 5, 1, 1, 0, 0};

/* --- CAN_ID_*_LOCK_* --- */
static const CanSignal_TypeDef kxCanSignalLockDoor = {1, 0, 0, 1, 1, 0, 0};
static const CanSignal_TypeDef kxCanSignalLockDisable = {1, 0, 1, 1, 1, 0, 0};
static const CanSignal_TypeDef
    kxCanSignalLockTemp = /* Locker temp -20.0:50.0 */
    {0.5f, 32, 8, 8, 1, 1, 0};
static const CanSignal_TypeDef kxCanSignalLockPlatform = {1, 0, 16, 16,
                                                          1, 0, 0};
static const CanSignal_TypeDef kxCanSignalEngineRun = {1, 0, 31, 1, 1, 0, 0};
static const CanSignal_TypeDef
    kxCanSignalSSBucketRotate = /* Skid steer bucket rotation -100.00:100.00 */
    {0.0078125f, 0, 32, 16, 1, 1, 0};
static const CanSignal_TypeDef
    kxCanSignalSSBucketHeight = /* Skid steer bucket height -100.00:100.00 */
    {0.0078125f, 0, 48, 16, 1, 1, 0};

/* --- CAN_ID_CONFIG_AXLE --- */
static const CanSignal_TypeDef kxCanSignalSteerConfig = {0.004884f, 0, 0, 12,
                                                         1,         1, 0};
static const CanSignal_TypeDef kxCanSignalSteerTrim = /* Steering trim */
    {0.0078125f, 0, 0, 16, 1, 1, 0};

/* --- CAN_ID_DATA_AXLE_F (steering feedback) --- */
static const CanSignal_TypeDef kxCanSignalServoEnable = {1, 0, 0, 1, 1, 0, 0};
static const CanSignal_TypeDef kxCanSignalSteerCurrent = {0.0005f, 0, 16, 16,
                                                          1,       1, 0};
static const CanSignal_TypeDef kxCanSignalSteerVoltage = {0.003058f, 0, 32, 16,
                                                          1,         1, 0};
static const CanSignal_TypeDef kxCanSignalSteerTemp = {1, 0, 48, 16, 1, 1, 0};

/* --- CAN_ID_CONFIG_MECH_BRAKE_* --- */
static const CanSignal_TypeDef kxCanSignalBrakeConfigNominal = {1, 1280, 0, 10,
                                                                1, 0,    0};
static const CanSignal_TypeDef kxCanSignalBrakeConfigEngage = {1, 1280, 10, 10,
                                                               1, 0,    0};
...
static const CanSignal_TypeDef
    kxCanSignalBatCurrent = /* Battery current -100.0:100.0 */
    {0.1f, 0, 0, 16, 1, 1, 0};
static const CanSignal_TypeDef
    kxCanSignalBatVoltage = /* Total pack voltage 0.0:100.0 */
    {0.1f, 0, 16, 16, 1, 0, 0};
static const CanSignal_TypeDef
    kxCanSignalCellVoltMax = /* Max cell voltage 0.0:10.0 */
    {0.01f, 0, 32, 16, 1, 0, 0};
static const CanSignal_TypeDef
    kxCanSignalCellVoltMin = /* Min cell voltage 0.0:10.0 */
    {0.01f, 0, 48, 16, 1, 0, 0};
...
static const CanSignal_TypeDef kxCanSignalBatSoc = /* Battery SOC 0.0:100.0 */
    {0.1f, 0, 0, 16, 1, 0, 0};
static const CanSignal_TypeDef
    kxCanSignalTempMax = /* Max temperature -100.0:100.0 */
    {0.1f, 0, 16, 16, 1, 1, 0};
static const CanSignal_TypeDef
    kxCanSignalTempMin = /* Min temperature -100.0:100.0 */
    {0.1f, 0, 32, 16, 1, 1, 0};

/* --- CAN_ID_DIAGNOSE_* --- */
static const CanSignal_TypeDef kxCanSignalResetBoard = {1.0f, 0, 0, 1, 1, 0, 0};
static const CanSignal_TypeDef kxCanSignalWiFiOff = {1.0f, 0, 1, 1, 1, 0, 0};
static const CanSignal_TypeDef kxCanSignalBoardTest = {1.0f, 0, 2, 1, 1, 0, 0};

/* --- CAN_ID_FAULT_CLEAR --- */
static const CanSignal_TypeDef kxCanSignalFaultClearMotorFr = {1.0f, 0, 8, 1,
                                                               1,    0, 0};
static const CanSignal_TypeDef kxCanSignalFaultClearMotorFl = {1.0f, 0, 9, 1,
                                                               1,    0, 0};
static const CanSignal_TypeDef kxCanSignalFaultClearMotorRr = {1.0f, 0, 10, 1,
                                                               1,    0, 0};
static const CanSignal_TypeDef kxCanSignalFaultClearMotorRl = {1.0f, 0, 11, 1,
                                                               1,    0, 0};

/* --- CAN_ID_BEAT_* --- */
static const CanSignal_TypeDef
    kxCanSignalCanTxError = /* CAN Tx error counter 0:255 */
    {1.0f, 0, 0, 8, 1, 0, 0};
static const CanSignal_TypeDef
    kxCanSignalCanRxError = /* CAN Rx error counter 0:255 */
    {1.0f, 0, 8, 8, 1, 0, 0};
static const CanSignal_TypeDef kxCanSignalErrorData = {1.0f, 0, 16, 8, 1, 0, 0};
static const CanSignal_TypeDef kxCanSignalUptime = /* Uptime in seconds */
    {1.0f, 0, 24, 28, 1, 0, 0};
static const CanSignal_TypeDef kxCanSignalResetReason = {1.0f, 0, 52, 4,
                                                         1,    0, 0};

/* --- CAN_ID_SW_VERSION_* --- */
static const CanSignal_TypeDef kxCanSignalSwVersionMajor = {1.0f, 0, 0, 16,
                                                            1,    0, 0};
static const CanSignal_TypeDef kxCanSignalSwVersionMinor = {1.0f, 0, 16, 16,
                                                            1,    0, 0};
static const CanSignal_TypeDef kxCanSignalSwVersionPatch = {1.0f, 0, 32, 16,
                                                            1,    0, 0};
...
/* --- CAN_ID_CAN_HEALTH_* --- */
static const CanSignal_TypeDef kxCanSignalCanTxErrorMax = {1.0f, 0, 0, 8,
                                                           1,    0, 0};
static const CanSignal_TypeDef kxCanSignalCanRxErrorMax = {1.0f, 0, 8, 8,
                                                           1,    0, 0};
static const CanSignal_TypeDef kxCanSignalCanResetCount = {1.0f, 0, 16, 4,
                                                           1,    0, 0};

/* --- CAN_ID_FEATURE_ENABLE --- */
static const CanSignal_TypeDef kxCanSignalDisableAntiRollback = {1, 0, 0, 1,
                                                                 1, 0, 0};
static const CanSignal_TypeDef kxCanSignalDisableBrakeBlend = {1, 0, 1, 1,
                                                               1, 0, 0};
static const CanSignal_TypeDef kxCanSignalDisableEstopSteering = {1, 0, 2, 1,
                                                                  1, 0, 0};

/* --- CAN_ID_ACTIVE_CAL --- */
static const CanSignal_TypeDef kxCanSignalCalSteerTrim = {0.0078125f, 0, 0, 16,
                                                          1,          1, 0};
static const CanSignal_TypeDef kxCanSignalHomingComplete = {1.0f, 0, 32, 16,
                                                            1,    0, 0};

/* --- PDO Position --- */
static const CanSignal_TypeDef kxCanSignalPositionControl = {1.0f, 0, 0, 8,
                                                             1,    0, 0};
static const CanSignal_TypeDef kxCanSignalPositionAddress = {1.0f, 0, 8, 16,
                                                             1,    0, 0};
static const CanSignal_TypeDef kxCanSignalPositionData = {1.0f, 0, 16, 16,
                                                          1,    0, 0};

/* --- ODrive Set Input Pos --- */
static const CanSignal_TypeDef kxCanSignalInputPos = /* IEEE 754 float */
    {1, 0, 0, 32, 1, 0, 1};
static const CanSignal_TypeDef kxCanSignalVelFf = {0.001f, 0, 32, 16, 1, 0, 0};
static const CanSignal_TypeDef kxCanSignalTorqueFf = {0.001f, 0, 48, 16,
                                                      1,      0, 0};

/* --- ODrive Set Controller Mode --- */
static const CanSignal_TypeDef kxCanSignalControlMode = {1, 0, 0, 32, 1, 0, 0};
static const CanSignal_TypeDef kxCanSignalInputMode = {1, 0, 32, 32, 1, 0, 0};

/* --- ODrive Set Axis State --- */
static const CanSignal_TypeDef kxCanSignalAxisRequestedState = {1, 0, 0, 32,
                                                                1, 0, 0};
